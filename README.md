...
[README.md](https://github.com/user-attachments/files/25576942/README.md)
<div align="center">

# 🏗️ On-Prem GitOps Microservices Platform

**코드 푸시 한 번으로 빌드·배포·모니터링·알림까지 — 온프레미스 환경의 완전 자동화 운영 파이프라인**
...
| 항목 | Before | After |
|------|--------|-------|
| 🚀 배포 방식 | 수동 `kubectl apply` | **코드 푸시 → 자동 빌드 · 배포** |
